...
## Примечание по макетам

Ссылка на Figma из ТЗ в этой среде не открылась, поэтому интерфейс собран как аккуратный нативный UIKit-экран с упором на требования, а не на пиксель-перфект под конкретный макет.
